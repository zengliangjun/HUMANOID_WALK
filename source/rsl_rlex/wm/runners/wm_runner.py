...
from rsl_rlex.wm.modules.wm_modules import WMActorCritic
from rsl_rlex.wm.algorithms.wm_ppo import WMPPO
from rsl_rl.utils import store_code_state

class WMPolicyRunner(OnPolicyRunner):
    ...
    def __init__(self, env: VecEnv, train_cfg, log_dir=None, device="cpu"):
        ...
        actor_critic: WMActorCritic = actor_critic_class(self.policy_cfg).to(self.device)
        ...
        self.alg: WMPPO = alg_class(actor_critic, self.alg_cfg, device=self.device)
    ...
    def learn(self, num_learning_iterations: int, init_at_random_ep_len: bool = False):  # noqa: C901
        ...
        for it in range(start_iter, tot_iter):
            ...
            mean_value_loss, mean_surrogate_loss, mean_entropy, mean_rnd_loss, mean_symmetry_loss, \
                mean_continuous_loss, mean_discrete_loss, mean_reconstruct_loss = self.alg.update()
